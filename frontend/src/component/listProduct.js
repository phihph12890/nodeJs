            ...
            return `
                        <tr>
                            ...
                            <td class=" text-center border border-black" style="width: 50px;">
                                <div style="width: 30px;"><a href="/#/editproduct/${product._id}" class="text-sm px-1 border border-gray-600 rounded-lg bg-blue-500 hover:bg-blue-700 text-white btn btn-primary"><i class="px-1 far fa-edit"></i></a></div>
                            </td>
                            <td class=" text-center border border-black" >
                                <div style="width: 30px;"><button class="text-sm px-1 border border-gray-600 rounded-lg bg-red-500 hover:bg-red-700 text-white btn btn-danger btn-remove" data-id="${product._id}"><i class="px-1 fas fa-trash-alt"></i></button></div>
                            </td>
                        </tr>
                        `
        }).join('')}
